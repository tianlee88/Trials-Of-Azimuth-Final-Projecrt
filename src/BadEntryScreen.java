...
/**
 * This class implements the Bad Entry screen, which appears when a user tries to add an invalid string as a username
 * @authors Tian Lee, Paul Price, Christian Kennedy
 */
public class BadEntryScreen extends MenuOutline{
	...
	public void openMenu() {
		...
		//*********
		JLabel bad_entry = createLabel("badentry.png");
		middle_panel.add(bad_entry);
		//************
		JLabel please_enter = createLabel("pleaseenter.png");
		middle_panel.add(please_enter);
		//**********
